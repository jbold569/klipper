...
HOSTSERIAL='38FFDC053348523721692351-if00'
...
TOOLHEADSERIALS=('33FF6D064746373247200457-if00') # For multiple serials use: TOOLHEADSERIALS=('SERIAL_1' 'SERIAL_2' 'SERIAL_3')
